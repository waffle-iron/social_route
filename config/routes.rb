Rails.application.routes.draw do
  ...
  match '/naming_verification', to: 'static_pages#naming_verification', via: 'get'

  match '/api/accounts', to: 'api#dashboard', via: 'get'
  ...
  match '/api/naming_verification', to: 'api#naming_verification', via: 'get'
end
